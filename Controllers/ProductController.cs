...
namespace finallab.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Images(int id, HttpPostedFileBase file)
        {
            ...
            file.SaveAs(Server.MapPath(path)); //upload images to our folder that we created......
            ...
            return RedirectToAction("Index"); //Here we don't add return view because we want to redirect to product controller
